...
// 需要被验证应用的包名
const char *APP_PACKAGE_NAME = "me.decrypt.key";
// 应用签名，通过 JNIDecryptKey.getSignature(getApplicationContext()) 获取
...
// 需要被保护的密钥，请修改成你自己的密钥
const char *DECRYPT_KEY = "4264fd1ed19bbbb26dbf538d27ba512b";

// native 方法所在类的路径
const char *NATIVE_CLASS_PATH = "com/ld/decrypt/key/JNIDecryptKey";
